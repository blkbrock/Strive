...
class _WeightDataPageState extends State<WeightDataPage> {
  ...
  void uploadEntry(String newDate, String newWeight, String newBodyFat) async {
    databaseWeightRef.doc(userName).collection('Weight').add(
        {'Date': newDate, 'Weight': newWeight, 'bodyFat': newBodyFat});
  }
  ...
  void _showAddDialog() {
        ...
        void initState()
    {
      super.initState();
      _stream =
          databaseWeightRef.doc(userName).collection('Weight').snapshots();
    }
